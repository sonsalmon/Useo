...
class LibraryOtherScreenWidget extends StatefulWidget {
  ...
  @override
  _LibraryOtherScreenWidgetState createState() =>
      _LibraryOtherScreenWidgetState();
}

class _LibraryOtherScreenWidgetState extends State<LibraryOtherScreenWidget> {
                      ...
                      child: GridView(
                        ...
                        children: [
                          InkWell(
                            ...
                            highlightColor: Colors.transparent,
                            onTap: () async {
                              context.pushNamed('bookDetailScreen');
                            },
                            child: ClipRRect(
                              borderRadius: BorderRadius.circular(8.0),
                              child: Image.network(
