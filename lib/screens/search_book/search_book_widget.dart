...
import 'search_book_model.dart';
export 'search_book_model.dart';
...
class _SearchBookWidgetState extends State<SearchBookWidget>
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SearchBookModel());
                    ...
                    children: [
                      Padding(
                        ...
                        child: InkWell(
                          ...
                          onTap: () async {
                            context.pushNamed('LibraryScreen');
                          },
                          child: Container(
                            width: 100.0,
