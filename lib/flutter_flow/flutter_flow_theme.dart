...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF704214);
  late Color secondary = const Color(0xFF92C5A9);
  late Color tertiary = const Color(0xFF81845F);
  late Color alternate = const Color(0xFFE0E3E7);
  late Color primaryText = const Color(0xFF2C2C2C);
  late Color secondaryText = const Color(0xFF737373);
  late Color primaryBackground = const Color(0xFFF1F4F8);
  late Color secondaryBackground = const Color(0xFFFFFFFF);
  late Color accent1 = const Color(0xFF72B5A8);
  late Color accent2 = const Color(0xFF72A796);
  late Color accent3 = const Color(0xFF729983);
